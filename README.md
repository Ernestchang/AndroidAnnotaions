#Android Annotation 官方文档翻译

##前言
- **AndroidAnnotation**是一款Android便捷开发的框架，可以节省代码量；

- 翻译之中难免有些地方会有错误，对AndroidAnnotation **感兴趣的朋友** 可以参与到翻译之中；

- 虽然是基于官方的文档翻译的，不过在后面会结合一些开发实际，发布相应章节的**Demo**供参考。

- 欢迎大家加入QQ群 **157183329**，一起探讨 **Android开发框架** ，交流技术(加群的时候，请注明Github账号)。
